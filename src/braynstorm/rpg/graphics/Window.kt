...
object Window : Dirty {
	...
	val drawShader: ShaderProgram
	val pickingShader: ShaderProgram
...
//		GLFW.glfwSetWindowIcon(window, GLFWImage())
		...
		drawShader = ShaderProgram()
		drawShader.addShaders(true, ShaderManager["shader2d", ShaderType.FRAGMENT]!!, ShaderManager["shader2d", ShaderType.VERTEX]!!)
		drawShader.addAttribute("meshVertex", 0)
		drawShader.addAttribute("meshTexcoord", 1)
		...
		pickingShader.addShaders(true, ShaderManager["shader2d", ShaderType.VERTEX]!!, ShaderManager["picking", ShaderType.FRAGMENT]!!)
		pickingShader.addAttribute("meshVertex", 0)
		pickingShader.addAttribute("meshTexcoord", 1)
		
		pickingShader.addUniform("model")
		pickingShader.addUniform("view")
		pickingShader.addUniform("projection")
		pickingShader.addUniform("color")
		
		fontShader = ShaderProgram()
		fontShader.addShaders(true, *ShaderManager["font2d"])
		fontShader.addAttribute("meshVertex", 0)
		fontShader.addAttribute("meshColor", 1)
		
		fontShader.addUniform("model")
		fontShader.addUniform("view")
		fontShader.addUniform("projection")
